...
let state = {
  ...
  home: { weather: { temperature: '--', condition: '--', humidity: '--', city: '', updatedAt: '' }, widget: { topLeftText: 'if-kioyao.com', topRightText: 'Dorkioyao', avatar: { type: 'url', value: '' }, titleText: 'Dorkioyao', description: ['time, record life, record everything.', 'Happy, healthy, and peaceful.'], images: [{ type: 'url', value: '' }, { type: 'url', value: '' }, { type: 'url', value: '' }] }, weatherWidget: { recordText: ['Record time, record life,', 'record everything.'], image: { type: 'url', value: '' } } },
  allowQuote: true,
